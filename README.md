...
- [data/search_relevance_golden_set.json](data/search_relevance_golden_set.json): public search relevance golden set with locale, intent, rating, and rationale
- [scripts/summarize_search_relevance.py](scripts/summarize_search_relevance.py): dependency-free relevance rating summary script
- [outputs/search-relevance-report.md](outputs/search-relevance-report.md): generated relevance QA report

Run locally:

```bash
python scripts/summarize_case_scores.py
python scripts/summarize_search_relevance.py
```
